...
export default function DashboardPage() {
  const { user, loading } = useAuth(); // ✅ no Supabase call here
          ...
          <>
            ...
            {posts.length === 0 ? (
              <div style={{
                ...
                border: '1px dashed var(--border)', borderRadius: '10px', color: 'var(--ink-muted)',
              }}>
                  ...
                  <div key={post.id} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <Link href={`/blog/${post.slug}`} style={{
                        fontWeight: '600', color: 'var(--ink)', fontSize: '0.95rem',
